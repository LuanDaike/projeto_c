        ...
        <div class="col-md-8">
              <div class="card-body">
                <div class="d-flex justify-content-center">
                  <h1><b>Criar Novo Produto</b></h1></div>
                    <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price_center" type="number" class="form-control" name="price_center">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="it_available" type="boolean" class="form-control" name="it_available">
